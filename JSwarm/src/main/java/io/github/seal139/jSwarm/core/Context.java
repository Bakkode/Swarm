...
/**
 * Represent execution context. In terms of GPGPU, Context plays a crucial parts to manage resource.
 * 
 */
public interface Context extends AutoCloseable {
	...
	/**
	 * Load a {@link Class} of {@link Program} from a variadic (varargs) array. 
	 * This will combine each {@link Program} into a {@link Module}.
	 * @param programs A variadic (varargs) array that holds {@link Class} definition of {@link Program}.
	 * @return A {@link Module}.
	 */
	Module loadProgram(Class<? extends Program> ... programs);
	
	/**
	 * Load a {@link Class} of {@link Program} from {@link Collection}. 
	 * This will combine each {@link Program} into a {@link Module}.
	 * @param programs A {@link Collection} that holds {@link Class} definition of {@link Program}.
	 * @return A {@link Module}.
	 */
	...
	/**
	 * Get the maximum number of concurrent operations at once. By default this value is 4.
	 * 
	...
	/**
	 * Add new parallelism capabilities to existing. Useful if working with multiple kernel that can run independently.
	 * Also applicable in case to synchronize many {@link Vector} that contains massive amount of data.
	 * 
	 * @param additionalNumber Number of added parallelism.
	 */
	void addParallelismLevel(int additionalNumber);
