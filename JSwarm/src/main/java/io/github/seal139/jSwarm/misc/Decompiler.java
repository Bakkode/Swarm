...
public abstract class Decompiler  {
	...
	private static final class Default extends Decompiler {
		...
		private final class Cfr implements OutputSinkFactory {
			...
			public String getResult() {
				return "//Decompiled with CFR 0.152.\n\n" + ret.toString();
			}
	    };
		...
		public String process(List<Class<? extends Program>> cls, Function<String, String> srcGen) throws Exception {
			...
			Worker.await("Java Decompilation", 5);
	 ...
	 * This is for proof of work and should be avoided as long as dedicated decompiler
	 * for this specific purpose is available
	 * 
